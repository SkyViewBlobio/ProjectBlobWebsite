...
var myApp = angular.module('myApp', []); // [] for dependencies, if any

// Define a controller for the module
myApp.controller('blobioController', function ($scope) {
    ...
    $scope.aboutUsExpanded = false;
    $scope.featuresExpanded = false;
    $scope.loginExpanded = false;
    $scope.statsExpanded = false;

    $scope.toggleButton = function (button) {
        $scope[button + 'Expanded'] = !$scope[button + 'Expanded'];
    };
});
